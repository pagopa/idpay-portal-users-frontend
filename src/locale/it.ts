const it = {
  "verifyRequirements":{
    ...
    "isee.title": "Dichiarazione ISEE 2025",
    "isee.description":
      "Se sei in possesso di un ISEE 2025 inferiore a 25.000€, verrà effettuata una verifica con INPS",
    "isee.option.<25000": "Ho un ISEE inferiore a 25.000€",
    "isee.option.>=25000": "Ho un ISEE uguale o superiore a 25.000€",
    "isee.option.none": "Non ho un ISEE",
